...
% [Tdb, w, phi, h, Tdp, v, Twb] = Psychrometrics('Tdb',40,'phi',80); => Dat
% a for air at 40°C and 80% relative humidity
function [Tdb, w, phi, h, Tdp, v, Twb] = Psychrometrics(varargin)

if nargin == 0
    
    [Tdb, w, phi, h, Tdp, v, Twb] = Psychrometrics('Tdb',40,'phi',80)
    return;
