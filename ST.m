...
% Transfo 5 - 6 : isentropic relaxation with isentropic efficiency
    ...
    elseif reheat == 2
        ...
        T_52 = T_max;
        h_5s = adjust(T_52,[],s_6);
        h_52 = h_6 + eta_SiT2 * (h_5s-h_6);
        s_52 = adjust(T_52,h_52,[]);
    ...
    elseif reheat == 1 && constr == "vapor_ratio"
        ...
        T_5 = T_max;
        h_5s = adjust(T_5,0,s_6);
        h_5  = h_6 + eta_SiT2 * (h_5s-h_6);
        s_5  = adjust(T_5,h_5,0);
    ...
    if drumFlag
        ...
        while h_1 > 2e3
            ...
            while abs(p_1 - iter) > 1e-3
                iter = p_1;
                p_1  = p_7i(drum +1) + (XSteam('h_pT',p_1,T_9i(drum +1)) - h_7i(drum +1))*10;
            end
        ...
        while h_1 > 2e3
            ...
            while abs(p_1 - iter) > 1e-3
                iter = p_1;
                p_1  = p_7 + (XSteam('h_pT',p_1,T_8) - h_7)*10;
            end
            h_1 = XSteam('h_pT',p_1,T_1);
        end
        s_1 = XSteam('s_pT',p_1,T_1);
...
figure;
plot([sL,flip(sV)],[T,flip(T)]); hold on;
if reheat == 0 || nsout == 0
    TS = plot([s_1;s_2;s_3;s_4';s_5';s_6i;s_6;s_7;s_8;flip(s_9i)],...
        [T_1;T_2;T_3;T_4';T_5';T_6i;T_6;T_7;T_8;flip(T_9i)]);
elseif reheat == 1 && nsout >= 1
    TS = plot([s_1;s_2;s_3;s_4';s_5';s_6i(2:end);s_6;s_7;s_8;flip(s_9i)],...
        [T_1;T_2;T_3;T_4';T_5';T_6i(2:end);T_6;T_7;T_8;flip(T_9i)]);
else
    TS = plot([s_1;s_2;s_3;s_4';s_5';s_6i(3:end);s_6;s_7;s_8;flip(s_9i)],...
        [T_1;T_2;T_3;T_4';T_5';T_6i(3:end);T_6;T_7;T_8;flip(T_9i)]);
end
TS.Marker = 'o';
TS.MarkerSize = 5;
for i = 1:nsout
    ...
    elseif x_6i(i) <= 1
        TS = plot([s_6i(i),s_7i(i),s_7i(i+1)],[T_6i(i),T_7i(i),T_7i(i+1)]);
    else
        TS = plot([s_6i(i),XSteam('sV_T',T_7i(i)),s_7i(i),s_7i(i+1)],[T_6i(i),T_7i(i),T_7i(i),T_7i(i+1)]);
    end
    TS.Color = [0.4660 0.6740 0.1880];
    TS.Marker = 'o'; TS.MarkerSize = 5;
end
