...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if constr_comb == "lambda"
        ...
        while abs(Tmax - iter) > 1
            ...
            Tmax = (w*integral(@Cp_air,273,473)/200*M_air/.21 + LHV*M_c + Cp_CH4*25) /...
...
if display
    ...
    % pie chart - energy
        ...
        if drumFlag
            Irr_drum = m_v*(X_9i(drum+1)*h_9i(drum+1) + X_7i(drum-1)*h_7i(drum-1) ...
                + X_6i(drum)*h_6i(drum) - h_7i(drum));
